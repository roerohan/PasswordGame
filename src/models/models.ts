...
import chatSchema, {
    ChatInterface, MessageInterface, messageSchema, OnlineInterface, onlineSchema,
} from './chat';
...
export const Online: Model<OnlineInterface> = passwordDb.model('Online', onlineSchema);
